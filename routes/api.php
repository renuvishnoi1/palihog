...
Route::get('/categorylist', [App\Http\Controllers\ApiController::class,'getCategoryList']);
Route::post('/subcategorylist/', [App\Http\Controllers\ApiController::class,'subCategory']);
Route::post('/shop_product_list', [App\Http\Controllers\ApiController::class,'ShopProductListByCategory']);
